    ...
    public partial class App : Application
    {
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            if (Debugger.IsAttached)
            {
                ...
                Debug.WriteLine(e.ExceptionObject.InnerException);
        ...
        {
            (Application.Current.RootVisual as PhoneApplicationFrame).Navigate(new Uri("/HelpPage.xaml", UriKind.RelativeOrAbsolute));
